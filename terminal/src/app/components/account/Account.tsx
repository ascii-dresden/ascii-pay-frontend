...
export class AccountView extends React.Component<AccountProps, AccountState> implements EventHandler {
  ...
  addBarcode() {
    ...
    if (request.code.startsWith('https://pay.ascii.coffee?code=')) {
      let account_number = request.code.replace('https://pay.ascii.coffee?code=', '').replace(/-/g, ' ');
  ...
  render() {
    ...
    if (this.state.account !== null) {
      ...
      if (this.state.addNfcRequest !== null) {
        ...
        popup = (
          <Dialog title="Add new NFC Card to account" actions={actionList} large={true}>
            <div className="form">
              <div>
                <label>Account</label>
        ...
        if (request.code.startsWith('https://pay.ascii.coffee?code=')) {
          ...
          popup = (
            <Dialog title="Add new account number to account" actions={actionList} large={true}>
              <div className="form">
                <div>
                  <label>Account</label>
                  <input value={this.state.account.name} readOnly={true} />
          ...
          popup = (
            <Dialog title="Add new barcode to account" actions={actionList} large={true}>
              <div className="form">
                <div>
                  <label>Account</label>
                  <input value={this.state.account.name} readOnly={true} />
      ...
      <div id="account">
        <div id="account-left">
          <AccountList
            ...
            selectAccount={(account) => this.selectAccount(account)}
